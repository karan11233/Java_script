...
const user1 = new createUser("karan", 25);
const user2 = new createUser("karan1", 250);
...
A prototype is linked: The newly created object gets linked to the prototype property of the4
